...
상세 API 문서는 `~/plugins/kx-cdx/skills/cmux/references/API.md`를 참조할 것. 사용 전 반드시 해당 파일을 읽어 최신 명령어와 파라미터를 확인한다.
...
cmux list-surfaces --json               # 현재 워크스페이스 서피스 목록
```
...
# 각 서피스에 명령 전송
cmux send --surface surface:<id> "codex\n"
